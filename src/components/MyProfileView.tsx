...
export const MyProfileView: React.FC<MyProfileViewProps> = ({
  ...
  const tableTennisStatus = useMemo(() => {
    ...
    const nameLower = participant.firstName.toLowerCase();
    ...
    if (playingNow) {
      ...
      return {
        ...
        details: `Motstander: ${opponent || 'motstander'}. Gå til bordet!`,
      };
    }
    ...
    if (readyTable) {
      ...
      return {
        ...
        details: `Gjør deg klar. Motstander: ${opponent || 'motstander'}.`,
      };
    }
    ...
    if (waitingMatch) {
      ...
      return {
        ...
        details: opponent ? `Møter ${opponent}` : 'Venter på avklaring av motstander.',
      };
    }
